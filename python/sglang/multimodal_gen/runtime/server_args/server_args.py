...
class ServerArgs(DisaggServerArgsMixin):
    ...
    # MiniMax-H3 ref2va: short edge every reference image is resized to before
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parser.add_argument(
            ...
            help=(
                ...
                "resized to before it reaches Qwen3-VL and the video VAE. Must "
                "be a positive multiple of 32. Reference-image token count "
                "scales with the square of this value, so 1024 cuts it to a "
